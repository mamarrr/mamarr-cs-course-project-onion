...
public class Customer : BaseEntity, IManagementCompanyId, IHasCreatedAtMeta
{
    [Required]
    ...
    [Display(ResourceType = typeof(App.Resources.Domain.Customer), Name = nameof(App.Resources.Domain.Customer.Notes))]
